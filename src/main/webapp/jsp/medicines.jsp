			...
			<div class="row justify-content-center ">
				<div class="col-lg-6">
					<div class="section_title mb-55 text-center">
						...
						<p>"Health is a human right, not a privilege. Through the
							generosity of donors like you, we ensure that no one is left
							behind in their pursuit of well-being. Browse our available
							medicines and be a part of the healing journey."</p>
					</div>
				</div>
			</div>
			<div class="row justify-content-center">
				<%
				List<Pharmacist> pharmacists = (List) session.getAttribute("pharma");
				...
				<div class="col-lg-4 col-md-6">
					<div class="single_expert">
						...
						<div class="experts_name text-left">
							...
							<span>Address:</span> <span><%=pharmacist.getAddress()%></span>
						</div>
					</div>
				</div>
				<%
