					...
					<div class="row">
						<div class="col-xl-12">
							<div class="slider_text ">
								<span>Online Medicine Donation Software</span>
								<h3>
									<span>Bringing health</span> <br> to life for the whole
									world.
								</h3>
								<a href="donor" class="boxed-btn5">Donate Here!</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row align-items-center">
				...
				<div class="col-xl-6 col-lg-6">
					<div class="welcome_docmed_info">
						<h3>
							Welcome To <span>Online Medicine Donation Software.</span>
						</h3>
						<p>We envision a world where no one is denied access to vital
							medications due to financial constraints. By leveraging
							technology and the goodwill of our community, we strive to create
							a sustainable solution that addresses the disparities in
							healthcare access.</p>
						<ul>
							<li><i class="flaticon-verified"></i> Free Of Cost</li>
							<li><i class="flaticon-verified"></i> Efficiency</li>
							<li><i class="flaticon-verified"></i> Community</li>
						</ul>
				...
				<div class="col-lg-7">
					<div class="popup_box ">
						<div class="popup_inner">
							<h3>
								Registration Form <span>For NGO's</span>
							</h3>
							<form action="ngoreg" method="post">
								<div class="row">
									<div class="col-xl-9">
										<input type="text" name="ngoname" placeholder="NGO Name"
											required>
									</div>
									<div class="col-xl-3">
								...
								<%
								String messagen = (String) session.getAttribute("submit");
								if (messagen != null) {
								%>
								<%=messagen%>
								<%
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-4  col-md-6 col-lg-4">
						...
						<div class="info_button">
							<a href="login" class="boxed-btn3-white">Pharmacist</a> <a
								href="login" class="boxed-btn3-white">Admin</a>
