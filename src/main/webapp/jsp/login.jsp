				...
				<div class="col-lg-7">
					<div class="popup_box ">
						<div class="popup_inner">
							<%
							String message = (String) session.getAttribute("login-failed");
							if (message != null) {
							%>
							<%=message%>
							<%
							...
							%>
							<%
							String message2 = (String) session.getAttribute("error");
							if (message2 != null) {
							%>
							<%=message%>
							<%
							...
							<form action="login" method="post">
								<div class="row">
									...
									<%
									String message1 = (String) session.getAttribute("reg-success");
									if (message1 != null) {
									%>
									<%=message1%>
									<%
