			...
			<div class="row justify-content-center ">
				<div class="col-lg-6">
					<div class="section_title mb-55 text-center">
						<h3>Our Motive</h3>
						<p>Whether you're looking to donate medications, volunteer
							your time, or support our cause in other ways, there are many
							ways to get involved. Visit our website to learn more about how
