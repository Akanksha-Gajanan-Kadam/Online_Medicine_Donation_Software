...
<body>
				...
				<div class="col-lg-7">
					<div class="popup_box ">
						<div class="popup_inner">
							<%
							String message = (String) session.getAttribute("submit");
							if (message != null) {
							%>
							<%=message%>
							<%
							...
							<form action="donor" method="post">
								<div class="row">
									...
									<div class="col-xl-6">
										Medicine Image: <input type="file" name="medimage" alt="img"
											required>
									</div>
									<div class="col-xl-6">
										Prescription: <input type="file" name="preimage" alt="img"
											required>
									</div>
									<div class="col-xl-6">
										AadharCard : <input type="file" name="aadharimage" alt="img"
											required>
									</div>
									<div class="col-xl-12">
	...
	<form id="test-form" class="white-popup-block mfp-hide">
		<div class="popup_box ">
			<div class="popup_inner">
				<%
				String message1 = (String) session.getAttribute("failed-msg");
				if (message != null) {
				%>
				<%=message%>
				<%
	...
	<script>
		$('.datepicker').datepicker({
			...
			icons : {
				rightIcon : '_$tag_________________________$tag__'
			}
		});
		...
		$('.timepicker').timepicker({
			iconsLibrary : 'fontawesome',
			icons : {
				rightIcon : '_$tag________________________$tag__'
			}
		});
